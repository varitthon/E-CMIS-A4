(() => {
  ...
  function stagebar(state){
    ...
    const stages=['ลงรับและตรวจเรื่อง','มอบหมายเจ้าหน้าที่',`เจ้าหน้าที่จัดทำ${REVIEW_RECORD_NAME}`,'ผู้อำนวยการศูนย์รับเรื่องร้องเรียน พิจารณาและลงนาม','ผู้อำนวยการกองบริหารคดี พิจารณาและลงนาม',branchLabel];
