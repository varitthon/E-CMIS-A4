(() => {
  ...
  function stagebar(state){
    ...
    // เส้นทางเดียวต่อเนื่อง 15 ขั้น (A4 ขั้น 1-5 → A5 ขั้น 6-15) — เหมือน journeyStages ของระบบไต่สวน
    const JOURNEY=['รับเรื่อง','กลั่นกรอง/มอบหมาย','พิจารณา Form 3','อนุมัติ/เลขสำนวน',branchLabel,'รับสำนวน/มอบหมาย','ไต่สวนเบื้องต้น 213','กลั่นกรองรายงาน 213','คกก. มติรับไต่สวน','ไต่สวนชี้มูล 644','กลั่นกรองรายงาน 644','คกก. ชี้มูล','ดำเนินการตามมติ','ส่งอัยการ/หน่วยงานต้นสังกัด','ปิดสำนวน'];
  ...
  function officialOutgoingDocument(state,id){
    ...
    if(id==='1-04')return `<article class="a4-paper template-memo" id="activePaper">
      ...
      <div class="memo-metadata"><p><strong>ส่วนราชการ</strong> สำนัก/กอง ........................................................ <strong>โทร.</strong> ........................</p><p><strong>ที่</strong> ${outgoingAt(state,id)||'ปป ๐๐ ....../........'} <strong>วันที่</strong> ........................................................</p><p><strong>เรื่อง</strong> ส่งสำนวนเรื่องกล่าวหาร้องเรียน กรณี <span class="doc-editable" data-editable="documentSubject" contenteditable="true" spellcheck="false">${escapeHtml(d.documentSubject||c.subject)}</span></p><p><strong>เรียน</strong> ผู้อำนวยการสำนัก/กอง</p></div>
