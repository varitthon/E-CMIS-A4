...
const ROLES = [
  ...
  /* ── 6. กองกฎหมาย ─────────────────────────────────────────────────── */
  { id:'admin_legal', login:'Kanda.R', row:9, group:'กองกฎหมาย (กอท.)', title:'เจ้าหน้าที่ธุรการกองกฎหมาย',
    name:'นางกานดา รักษ์ธรรม', org:'กองกฎหมาย (กอท.)', act:'10.1, 10.2, 10.3',
    responsibilities:'รับเรื่องเข้าระบบ/สแกนเอกสาร, ลงทะเบียนออกเลขรับในระบบของกองกฎหมาย และเสนอเรื่องต่อ ผอ.กองกฎหมาย',
    note:'มีหน้าที่รับเรื่องเข้าระบบ และดูแลระบบทะเบียนคุมเอกสารของกองกฎหมาย',
    perms:['view.all','download','intake.screen','intake.route','assign.work'] },
  ...
  { id:'group_director', login:'Arnon.C', row:11, group:'กองกฎหมาย (กลุ่มงานความเห็นแย้ง)', title:'ผู้อำนวยการกลุ่มงานความเห็นแย้ง',
    name:'นายอานนท์ ชินประชา', org:'กองกฎหมาย (กอท.)', act:'10.1, 10.2, 10.3',
  ...
  { id:'dir_legal', login:'Napas.S', row:12, group:'กองกฎหมาย', title:'ผู้อำนวยการกองกฎหมาย',
    name:'นายนภัส สอนดี', org:'กองกฎหมาย', act:'10.1, 10.2, 10.3',
