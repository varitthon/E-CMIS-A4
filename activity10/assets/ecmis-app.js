...
(function (global) {
  ...
  const ROLES = [
    /* ── 1. คณะกรรมการ ป.ป.ท. ─────────────────────────────────────────── */
    {
      ...
      title: "ประธานกรรมการ ป.ป.ท.",
      name: "นายวิชัย ยุติธรรม",
      org: "คณะกรรมการ ป.ป.ท.",
      act: "10.1, 10.2, 10.3",
      responsibilities:
        "รับทราบคำวินิจฉัยอัยการสูงสุด (ในกรณีเห็นแย้ง), ลงนามในมติการเปิดเผยข้อมูล, ลงนามในคำให้การ/คำชี้แจงต่อศาลปกครอง และหนังสือมอบอำนาจ",
    ...
    },
    {
      ...
      group: "คณะกรรมการ ป.ป.ท.",
      title: "กรรมการ ป.ป.ท.",
      name: "นายสมบูรณ์ ธรรมรัฐ",
      org: "คณะกรรมการ ป.ป.ท.",
      act: "10.1, 10.2, 10.3",
      responsibilities:
        'พิจารณาลงมติ "เห็นชอบ/เห็นแย้ง" กับความเห็นอัยการ, พิจารณาอนุมัติเปิดเผยข้อมูลข่าวสาร และตรวจความถูกต้องของคำให้การคดีปกครอง',
    ...
    /* ── 2. คณะอนุกรรมการ ─────────────────────────────────────────────── */
    {
      id: "subcommittee_screen",
      login: "Kitti.P",
      row: 3,
      group: "คณะอนุกรรมการ",
      title: "คณะอนุกรรมการพิจารณากลั่นกรองการเปิดเผยข้อมูลข่าวสาร",
      name: "นายกิตติ ปรีชาญาณ",
      org: "ส่วนกลาง",
      act: "10.2",
      responsibilities:
        "พิจารณาและให้ความเห็นเบื้องต้นเกี่ยวกับคำขอเปิดเผยข้อมูลข่าวสาร ก่อนเสนอเข้าที่ประชุมคณะกรรมการ ป.ป.ท.",
      note: "กลั่นกรองเรื่องก่อนเสนอเข้าบอร์ดชุดใหญ่ (เฉพาะกิจกรรม 10.2 เท่านั้น)",
      perms: ["view.assigned", "download", "support.opinion"],
    },
    {
      id: "subcommittee_appeal",
      login: "Sumet.N",
      row: 4,
      group: "คณะอนุกรรมการ",
      title: "คณะอนุกรรมการวินิจฉัยอุทธรณ์",
      name: "นายสุเมธ นิติธรรม",
      org: "ส่วนกลาง",
      act: "10.2",
      responsibilities:
        "พิจารณาวินิจฉัยคำอุทธรณ์ ในกรณีที่ ป.ป.ท. มีมติไม่อนุญาตให้เปิดเผยข้อมูล",
    ...
    /* ── 3. คณะผู้บริหาร ───────────────────────────────────────────────── */
    {
      ...
      row: 5,
      group: "คณะผู้บริหาร",
      title: "เลขาธิการ คณะกรรมการ ป.ป.ท. ผู้ดูแลกองกฎหมาย",
      name: "นายอภิชาติ สุจริตกุล",
      org: "สำนักงาน ป.ป.ท.",
      act: "10.1, 10.2, 10.3",
      responsibilities:
        "พิจารณากลั่นกรองความเห็นของนิติกรก่อนเสนอบอร์ด และลงนามในหนังสือถึงอัยการ/ศาล",
    ...
    },
    {
      ...
      row: 6,
      group: "คณะผู้บริหาร",
      title: "รองเลขาธิการ ป.ป.ท. ผู้ดูแลกองกฎหมาย",
      name: "นายสุรพงษ์ วัฒนา",
      org: "สำนักงาน ป.ป.ท.",
      act: "10.1, 10.2, 10.3",
      responsibilities:
        "พิจารณากลั่นกรองงาน และลงนามปฏิบัติราชการแทนเลขาธิการในงานที่ได้รับมอบหมาย (เช่น กำกับดูแลกองกฎหมาย)",
    ...
    /* ── 4. กองบริหารคดี ───────────────────────────────────────────────── */
    {
      ...
      login: "Siriporn.K",
      row: 7,
      group: "กองบริหารคดี (กลุ่มงานกิจการคณะกรรมการ)",
      title: "เจ้าหน้าที่กองบริหารคดี",
      name: "นางสาวศิริพร กิจการ",
      org: "กองบริหารคดี",
      act: "10.1, 10.2, 10.3",
      responsibilities:
        "จัดทำรายงาน/แจ้งมติให้หน่วยงานเจ้าของสำนวนทราบ และสรุปสถิติ/บันทึกมติคณะกรรมการ ป.ป.ท. ในภาพรวม",
    ...
    /* ── 5. กอง/สำนักเจ้าของเรื่อง ────────────────────────────────────────── */
    {
      ...
      login: "Somchai.J",
      row: 8,
      group: "กอง/สำนักเจ้าของเรื่อง",
      title: "นิติกร/นักสืบเจ้าของเรื่อง (เจ้าของสำนวนเดิม)",
      name: "นายสมชาย ใจซื่อ",
      org: "สนง. ป.ป.ท. เขต 1",
      act: "10.1, 10.2, 10.3",
      responsibilities:
        "ให้ข้อมูลข้อเท็จจริงประกอบการวิเคราะห์ความเห็นแย้ง, ให้ความเห็นประกอบการพิจารณาเปิดเผยข้อมูล และสนับสนุนข้อมูล/เอกสารในคดีปกครอง",
    ...
    /* ── 6. กองกฎหมาย ─────────────────────────────────────────────────── */
    {
      ...
      row: 9,
      group: "กองกฎหมาย (กอท.)",
      title: "เจ้าหน้าที่ธุรการกองกฎหมาย",
      name: "นางกานดา รักษ์ธรรม",
      org: "กองกฎหมาย (กอท.)",
      act: "10.1, 10.2, 10.3",
      responsibilities:
        "รับเรื่องเข้าระบบ/สแกนเอกสาร, ลงทะเบียนออกเลขรับในระบบของกองกฎหมาย และเสนอเรื่องต่อ ผอ.กองกฎหมาย",
      note: "มีหน้าที่รับเรื่องเข้าระบบ และดูแลระบบทะเบียนคุมเอกสารของกองกฎหมาย",
      perms: [
        "view.all",
        "download",
        "intake.screen",
    ...
    },
    {
      ...
      row: 10,
      group: "กองกฎหมาย",
      title: "นิติกร (ผู้รับผิดชอบสำนวน)",
      name: "นายณัฐพล บัวทุม",
      org: "กองกฎหมาย",
      act: "10.1, 10.2, 10.3",
      responsibilities:
        "วิเคราะห์ข้อกฎหมาย/ข้อเท็จจริง, จัดทำบันทึกความเห็น (เห็นชอบ/เห็นแย้ง), ร่างคำให้การ/คำแก้อุทธรณ์คดีปกครอง และติดตามสถานะ/ผลคำพิพากษา",
    ...
    {
      id: "case_legal_officer",
      login: "Kittisak.S",
      row: 10.5,
      group: "กองกฎหมาย (กลุ่มงานคดี)",
      title: "นิติกร กลุ่มงานคดี",
      name: "นายกิตติศักดิ์ แสงทอง",
      org: "กองกฎหมาย (กอท.)",
      act: "10.3",
      responsibilities:
        "ตรวจสอบคำฟ้องคดีปกครองเพื่อหามูลเหตุคดี ประสานนักสืบเจ้าของสำนวน จัดทำบันทึกสรุปความเห็น ร่างคำให้การ/คำแก้อุทธรณ์ และติดตามสถานะ/ผลคำพิพากษาคดีปกครอง",
      note: "รับผิดชอบสำนวนคดีปกครองในกลุ่มงานคดีโดยเฉพาะ",
      perms: ["view.all", "download", "legal.opinion", "doc.generate"],
    },
    {
      id: "group_director",
      login: "Arnon.C",
      row: 11,
      group: "กองกฎหมาย (กลุ่มงานความเห็นแย้ง)",
      title: "ผู้อำนวยการกลุ่มงานความเห็นแย้ง",
      name: "นายอานนท์ ชินประชา",
      org: "กองกฎหมาย (กอท.)",
      act: "10.1, 10.2, 10.3",
      responsibilities:
        "ตรวจพิจารณาสำนวนที่ได้รับมอบหมายจาก ผอ.กองกฎหมาย และมอบหมายสั่งการให้นิติกรผู้รับผิดชอบสำนวนดำเนินการจัดทำความเห็นแย้ง/คำให้การ",
      note: "พิจารณาและมอบหมายส่งต่องานให้นิติกรในกลุ่มงานความเห็นแย้ง",
      perms: ["view.all", "download", "assign.officer", "approve.group"],
    },
    {
      id: "case_group_director",
      login: "Pichai.R",
      row: 11.5,
      group: "กองกฎหมาย (กลุ่มงานคดี)",
      title: "ผู้อำนวยการกลุ่มงานคดี",
      name: "นายพิชัย เรืองศรี",
      org: "กองกฎหมาย (กอท.)",
      act: "10.3",
      responsibilities:
        "ตรวจพิจารณาสำนวนคดีปกครองที่ได้รับมอบหมายจาก ผอ.กองกฎหมาย และมอบหมายสั่งการให้นิติกรกลุ่มงานคดีดำเนินการตรวจคำฟ้อง จัดทำบันทึกความเห็น และเอกสารในชั้นศาล",
      note: "พิจารณาและมอบหมายส่งต่องานให้นิติกรในกลุ่มงานคดี",
      perms: ["view.all", "download", "assign.officer", "approve.group"],
    },
    {
      id: "dir_legal",
      ...
      row: 12,
      group: "กองกฎหมาย",
      title: "ผู้อำนวยการกองกฎหมาย",
      name: "นายนภัส สอนดี",
      org: "กองกฎหมาย",
      act: "10.1, 10.2, 10.3",
      responsibilities:
        "มอบหมายงานให้นิติกร, ตรวจสอบความถูกต้องของความเห็นทางกฎหมาย และลงนามเห็นชอบตามลำดับขั้น",
    ...
    /* ── 7. สำนักงานเลขาธิการ ───────────────────────────────────────────── */
    {
      ...
      login: "Anucha.S",
      row: 13,
      group: "สำนักงานเลขาธิการ",
      title: "สารบรรณกลาง",
      name: "นายอนุชา สารบรรณ",
      org: "สำนักงานเลขาธิการ",
      act: "10.1, 10.2, 10.3",
      responsibilities:
        "รับเอกสาร/คำร้อง/หมายเรียกจากภายนอก (อัยการ/ศาล/ประชาชน) ลงทะเบียนรับเรื่อง ออกเลขรับ-ส่ง และส่งต่อให้กองที่เกี่ยวข้อง",
    ...
    /* ── 12. ฝ่ายเลขานุการคณะอนุกรรมการ (กิจกรรม 10.2) ─────────────────── */
    {
      id: "sub_secretariat",
      login: "Pimchanok.T",
      row: 14,
      group: "กองกฎหมาย",
      title:
        "ฝ่ายเลขานุการคณะอนุกรรมการพิจารณากลั่นกรองการเปิดเผยข้อมูลข่าวสาร",
      name: "นางสาวพิมพ์ชนก ธรรมรักษ์",
      org: "กองกฎหมาย (กกม.)",
      act: "10.2",
      responsibilities:
        "วิเคราะห์ประเด็นกฎหมายและจัดทำรายงานความเห็นเสนอคณะอนุกรรมการพิจารณากลั่นกรองการเปิดเผยข้อมูลข่าวสาร, รวบรวมคำร้องบรรจุเข้าวาระการประชุม, นัดหมายคณะอนุกรรมการและจัดส่งเอกสารประกอบการประชุม, จัดทำผลมติและหนังสือแจ้งมติ",
      note: "ลงนามในฐานะ \"อนุกรรมการและเลขานุการ คณะอนุกรรมการพิจารณากลั่นกรองการเปิดเผยข้อมูลข่าวสาร\" (เฉพาะกิจกรรม 10.2)",
      perms: [
        "view.assigned",
        "download",
        "draft.doc",
    ...
    /* ── 15-18. บทบาทใหม่สำหรับ Flow 4 — อุทธรณ์คำสั่งไม่เปิดเผยข้อมูล
       (กิจกรรม 10.2, drawio หน้า 6, ดู docs/10-2-flow4-appeal-plan.md) ─────── */
    {
      id: "case_bureau_director",
      login: "Pattama.B",
      row: 15,
      group: "กองบริหารคดี",
      title: "ผู้อำนวยการกองบริหารคดี",
      name: "นางปัทมา บริหารกิจ",
      org: "กองบริหารคดี",
      act: "10.2",
      responsibilities:
        "พิจารณาเรื่องอุทธรณ์คำสั่งไม่เปิดเผยข้อมูลและมอบหมายกลุ่มงานบริหารติดตามคดี, พิจารณานำเรื่องเข้าที่ประชุมคณะกรรมการ ป.ป.ท. (กิจกรรมที่ 7)",
      note: "ผู้บังคับบัญชาระดับผู้อำนวยการของกองบริหารคดี เฉพาะสายงานอุทธรณ์ (กิจกรรม 10.2)",
      perms: ["view.assigned", "download", "assign.work", "approve.general"],
    },
    {
      id: "case_tracking_director",
      login: "Wichai.T",
      row: 16,
      group: "กองบริหารคดี",
      title: "ผู้อำนวยการกลุ่มงานบริหารติดตามคดี",
      name: "นายวิชัย ติดตามกิจ",
      org: "กองบริหารคดี",
      act: "10.2",
      responsibilities:
        "พิจารณาและมอบหมายนิติกรเจ้าของสำนวนดำเนินการเรื่องอุทธรณ์, ลงนามส่งต่อผู้อำนวยการกองบริหารคดีก่อนนำเรื่องเข้าที่ประชุมคณะกรรมการ ป.ป.ท.",
      note: "กำกับดูแลกลุ่มงานบริหารติดตามคดี เฉพาะสายงานอุทธรณ์ (กิจกรรม 10.2)",
      perms: ["view.assigned", "download", "assign.work", "sign.own"],
    },
    {
      id: "appeal_subcommittee_secretariat",
      login: "Malee.S",
      row: 17,
      group: "คณะอนุกรรมการ",
      title: "ฝ่ายเลขาคณะอนุกรรมการวินิจฉัยอุทธรณ์",
      name: "นางสาวมาลี เสรีกิจ",
      org: "กองบริหารคดี",
      act: "10.2",
      responsibilities:
        "จัดทำวาระเสนอคณะอนุกรรมการวินิจฉัยอุทธรณ์, จัดทำบันทึกคำวินิจฉัยเสนอเข้าที่ประชุมคณะกรรมการ ป.ป.ท.",
      note: "ทำหน้าที่เลขานุการของคณะอนุกรรมการวินิจฉัยอุทธรณ์โดยเฉพาะ (กิจกรรม 10.2)",
      perms: ["view.assigned", "download", "draft.doc", "manage.agenda"],
    },
    {
      id: "appeal_ruling_subcommittee",
      login: "Sompong.V",
      row: 18,
      group: "คณะอนุกรรมการ",
      title:
        "คณะอนุกรรมการวินิจฉัยอุทธรณ์คำสั่งไม่เปิดเผยข้อมูลหรือข้อเท็จจริง",
      name: "นายสมพงษ์ วินิจฉัยกุล",
      org: "ส่วนกลาง",
      act: "10.2",
      responsibilities:
        "พิจารณาและมีคำวินิจฉัยคำอุทธรณ์คำสั่งไม่เปิดเผยข้อมูลหรือข้อเท็จจริง ก่อนเสนอเข้าที่ประชุมคณะกรรมการ ป.ป.ท. เต็มคณะ",
    ...
    {
      /* จุดเริ่มต้นอุทธรณ์ทางที่ 2 (สาย "เขต" ในผัง TO-BE) — รับหนังสืออุทธรณ์ที่
         ยื่นตรงที่เขต แล้วส่งตรงถึงนิติกรเจ้าของสำนวนได้เลย ไม่ต้องผ่าน ผอ.กองบริหารคดี/
         ผอ.กลุ่มงานติดตามคดีมอบหมายเหมือนสาย "ส่วนกลาง" (case_bureau_admin) ดู
         docs/10-2-flow4-appeal-plan.md หัวข้อจุดเริ่มต้น 2 ทาง */
      id: "district_admin",
      login: "Kittipong.D",
      row: 21,
      group: "เขต",
      title: "เจ้าหน้าที่เขต",
      name: "นายกิตติพงษ์ ดูแลเขต",
      org: "สนง. ป.ป.ท. เขต 4",
      act: "10.2",
      responsibilities:
        "รับเรื่องอุทธรณ์ที่ยื่นตรงที่เขตและบันทึกเข้าสู่ระบบ ส่งตรงถึงนิติกรเจ้าของสำนวนโดยไม่ผ่านกองบริหารคดี (sheet 6 อุทธรณ์คำสั่งไม่เปิดเผยข้อมูล — สายเขต)",
      note: "คนละคนกับ case_bureau_admin (ธุรการกองบริหารคดี, สายส่วนกลาง) — ทั้งสอง role ผลิตสถานะคนละค่ากัน ก่อนจะมาบรรจบที่นิติกรเจ้าของสำนวนจุดเดียวกัน",
      perms: ["view.assigned", "download", "assign.work"],
    },
  ];
  ...
  const DOC_TYPES = {
    213: {
      code: "213",
      label: "รายงานการไต่สวนเบื้องต้น (แบบ ปปท. ๒-๑๓)",
      short: "รายงาน 213",
      sla: { waitSign: 5, completeSign: 3 },
    },
    644: {
      code: "644",
      label: "รายงานการไต่สวนข้อเท็จจริง (แบบ ปปท. ๖-๔๔)",
      short: "รายงาน 644",
  ...
  const SIGN_PHASE = {
    ...
    COMPLETE: {
      key: "COMPLETE",
      label: "ลงนามแล้ว รอส่งต่อให้ครบ",
      slaKey: "completeSign",
    },
  };
  ...
  const PERM_DEFS = [
    {
      k: "view.all",
      cat: "การเข้าถึง",
      label: "ดูสำนวนได้ทุกเรื่องในกิจกรรมที่ 7",
    },
    {
      k: "view.own",
      cat: "การเข้าถึง",
      label: "ดูได้เฉพาะสำนวนของตนเอง",
      note: "ชีตแถว 17",
    },
    {
      k: "view.assigned",
      cat: "การเข้าถึง",
      label: "ดูได้เฉพาะสำนวนที่ได้รับมอบหมายให้คณะของตน",
    },
    { k: "download", cat: "การเข้าถึง", label: "ดาวน์โหลดเอกสารได้ทุกเรื่อง" },
    {
      k: "download.own",
      cat: "การเข้าถึง",
      label: "ดาวน์โหลดได้เฉพาะสำนวนของตนเอง",
      note: "ชีตแถว 17",
    },
    {
      k: "EDIT.MASTER",
      cat: "การแก้ไข",
      label: "แก้ไขมติ / คำสั่ง / รายงานในระบบ",
      note: "สิทธิพิเศษสูงสุด — ชีตแถว 15 ระบุว่ามีเพียง 7 คนเท่านั้น (เจ้าหน้าที่กลุ่มงานกิจการฯ 6 + ผอ.กบค. 1)",
      critical: true,
    },
    {
      k: "record.minutes",
      cat: "การแก้ไข",
      label: "บันทึกมติที่ประชุมเข้าระบบ",
    },
    { k: "lock.pdf", cat: "การแก้ไข", label: "ล็อกไฟล์ PDF มติ" },
    {
      k: "compile.minutes",
      cat: "การแก้ไข",
      label: "Auto-compile รายงานการประชุมรวม",
    },
    ...
    { k: "secrecy.set", cat: "การแก้ไข", label: "กำหนดชั้นความลับของเอกสาร" },
    {
      k: "order24.draft",
      cat: "การแก้ไข",
      label: "ร่างคำสั่งแต่งตั้งคณะไต่สวน ม.24",
    },
    {
      k: "doc.generate",
      cat: "การแก้ไข",
      label: "สร้างเอกสารจาก Mail-Merge Template",
    },
    {
      k: "sign.report213",
      cat: "การลงนาม",
      label: "ลงนามดิจิทัลรายงาน 213 / 644",
    },
    { k: "sign.agenda", cat: "การลงนาม", label: "ลงนามสั่งบรรจุวาระการประชุม" },
    {
      k: "sign.order24p1",
      cat: "การลงนาม",
      label: "ลงนามคำสั่ง ม.24 วรรคหนึ่ง (องค์คณะ)",
    },
    {
      k: "sign.order24p3",
      cat: "การลงนาม",
      label: "ลงนามคำสั่ง ม.24 วรรคสาม (คณะอนุกรรมการไต่สวน)",
    },
    ...
    { k: "sign.general", cat: "การลงนาม", label: "ลงนามหนังสือทั่วไป" },
    {
      k: "certify.urgent",
      cat: "จุดควบคุม",
      label: "รับรองเหตุผลเร่งด่วนบนใบด่วน",
      note: "จุดควบคุม Bypass — ชีตแถว 20",
      critical: true,
    },
    {
      k: "bypass.approve",
      cat: "จุดควบคุม",
      label: "สั่งบรรจุวาระด่วนข้ามอนุกลั่นกรองฯ",
      note: "ชีตแถว 1",
    },
    {
      k: "assign.subcommittee",
      cat: "จุดควบคุม",
      label: "กระจายสำนวนเข้าคณะอนุกลั่นกรองฯ 1-8",
    },
    {
      k: "decide.complex",
      cat: "จุดควบคุม",
      label: "ตัดสินว่าเป็นเรื่องยุ่งยากซับซ้อน (G1)",
    },
    { k: "return", cat: "จุดควบคุม", label: "ส่งคืนสายงานต้นทาง (Return)" },
    {
      k: "vote",
      cat: "การประชุม",
      label: "ลงมติในที่ประชุมคณะกรรมการ",
      note: "กรรมการที่มีส่วนได้เสียถูกกันสิทธิ์นี้ตาม ม.20 — ชีตแถว 2",
      critical: true,
    },
    {
      k: "read.agenda.advance",
      cat: "การประชุม",
      label: "อ่านระเบียบวาระล่วงหน้า 3 วัน",
    },
    {
      k: "present.board",
      cat: "การประชุม",
      label: "ชี้แจงต่อบอร์ดแทนนักสืบ (ชั้นไต่สวนเบื้องต้น)",
      note: "ชีตแถว 10",
    },
    {
      k: "present.board.ruling",
      cat: "การประชุม",
      label: "ชี้แจงต่อบอร์ดด้วยตนเอง (ชั้นวินิจฉัยชี้มูล)",
    },
    {
      k: "screen.vote",
      cat: "การประชุม",
      label: "ลงมติกลั่นกรองในคณะอนุกลั่นกรองฯ",
    },
    {
      k: "screen.minutes",
      cat: "การประชุม",
      label: "บันทึกมติคณะอนุกลั่นกรองฯ",
    },
    {
      k: "support.opinion",
      cat: "การประชุม",
      label: "เสนอความเห็นคณะอนุสนับสนุนฯ",
    },
    {
      k: "support.certify",
      cat: "การประชุม",
      label: "รับรองมติคณะอนุสนับสนุนฯ",
    },
    {
      k: "support.minutes",
      cat: "การประชุม",
      label: "บันทึกมติคณะอนุสนับสนุนฯ",
    },
    {
      k: "request.moreinfo",
      cat: "การประชุม",
      label: "ขอเอกสาร/ข้อมูลเพิ่มเติมจากเจ้าของสำนวน",
    },
    ...
    { k: "urgent.request", cat: "ปลายน้ำ", label: "ยื่นใบด่วนขอบรรจุวาระ" },
    {
      k: "urgent.endorse",
      cat: "ปลายน้ำ",
      label: "เห็นชอบใบด่วนเบื้องต้นก่อนส่ง ผอ.กบค.",
    },
    {
      k: "dispatch.resolution",
      cat: "ปลายน้ำ",
      label: "ส่งมติคืนกอง / สนง. ป.ป.ท. เขต",
    },
    {
      k: "dispatch.nacc",
      cat: "ปลายน้ำ",
      label: "ทำหนังสือนำส่งสำนวนถึง ป.ป.ช.",
    },
    {
      k: "track.discipline",
      cat: "ปลายน้ำ",
      label: "ติดตามผลการดำเนินการทางวินัย (เชื่อม กจ.8)",
    },
    {
      k: "intake.screen",
      cat: "ปลายน้ำ",
      label: "ลงรับและคัดกรองสำนวนอิเล็กทรอนิกส์",
    },
    {
      k: "intake.route",
      cat: "ปลายน้ำ",
      label: "รับเรื่องจากสารบรรณและส่งเข้าอนุกลั่นกรองฯ",
    },
    {
      k: "route.subcommittee",
      cat: "ปลายน้ำ",
      label: "ส่งเรื่องเข้าอนุกลั่นกรองฯ ตามคำสั่งประธานฯ",
    },
    {
      k: "memo.submit",
      cat: "ปลายน้ำ",
      label: "จัดทำบันทึกเสนอนำเรียนประธานฯ",
    },
    {
      k: "legal.opinion",
      cat: "ปลายน้ำ",
      label: "จัดทำบันทึกความเห็นทางกฎหมาย",
    },
    {
      k: "docnumber.issue",
      cat: "ปลายน้ำ",
      label: "ออกเลขหนังสือ / เลขคำสั่ง",
      note: "นอกขอบเขต E-CMIS",
    },
    {
      k: "admin.sla",
      cat: "ผู้ดูแลระบบ",
      label: "ตั้งค่าจำนวนวันแจ้งเตือนกรอบเวลา",
    },
    {
      k: "admin.users",
      cat: "ผู้ดูแลระบบ",
      label: "บริหารผู้ใช้ ประเภทตำแหน่ง และสิทธิ์",
    },
    {
      k: "admin.reassign",
      cat: "ผู้ดูแลระบบ",
      label: "Re-assign ผู้พิจารณากรณีลา / ตำแหน่งว่าง",
    },
  ...
  function canEditMaster(roleId) {
    return can("EDIT.MASTER", roleId);
  }
  ...
  function canViewCase(kase, roleId) {
    ...
    if (can("view.own", r.id))
      return kase.owner === r.name || kase.ownerOrg === r.org;
    return false;
  }
  ...
  const STATUS = {
    ...
    DRAFT: {
      label: "ร่างรายงาน 213 (ในกอง/เขต)",
      cls: "st-draft",
      owner: "owner",
      scope: "UPSTREAM",
    },
    RETURNED: {
      label: "ส่งคืน กจ.5 — รอแก้ไข",
      cls: "st-returned",
      owner: "owner",
      scope: "UPSTREAM",
    },
    PENDING_SECTION: {
      label: "รอหัวหน้ากลุ่มงาน (ในกอง/เขต)",
      cls: "st-pending",
      owner: "section_head",
      scope: "UPSTREAM",
    },
    PENDING_DIRECTOR: {
      label: "รอ ผอ.กอง / ผอ.เขต",
      cls: "st-pending",
      owner: "director",
      scope: "UPSTREAM",
    },
    PENDING_DEPUTY: {
      label: "รอผู้ช่วย / รองเลขาธิการฯ",
      cls: "st-pending",
      owner: "deputy",
      scope: "UPSTREAM",
    },
    ...
    PENDING_SECGEN: {
      label: "รอเลขาธิการฯ ลงนาม",
      cls: "st-pending",
      owner: "secgen",
    },
    IN_SUPPORT_SUB: {
      label: "อยู่คณะอนุสนับสนุนฯ",
      cls: "st-review",
      owner: "support_sub",
    },
    PENDING_URGENT: {
      label: "รอ ผอ.กบค. รับรองใบด่วน",
      cls: "st-urgent",
      owner: "dir_case",
    },
    PENDING_CHAIR_OF: {
      label: "รอหน้าห้องประธานฯ คัดกรอง",
      cls: "st-pending",
      owner: "chair_office",
    },
    PENDING_CHAIRMAN: {
      label: "รอประธานฯ สั่งการ",
      cls: "st-pending",
      owner: "chairman",
    },
    IN_SCREENING: {
      label: "อยู่อนุกลั่นกรองฯ",
      cls: "st-review",
      owner: "subcommittee",
    },
    AGENDA_SET: {
    ...
    IN_MEETING: {
      label: "อยู่ระหว่างประชุมบอร์ด",
      cls: "st-review",
      owner: "board_sec",
    },
    DEFERRED: {
      label: "เลื่อน/ถอนวาระ — รอเลขวาระใหม่",
      cls: "st-returned",
      owner: "affairs",
    },
    RESOLVED_PENDING: {
      label: "มีมติแล้ว รอล็อก PDF/ลงนาม",
      cls: "st-pending",
      owner: "board_sec",
    },
    RESOLVED: { label: "มีมติแล้ว", cls: "st-done", owner: "board_sec" },
    DISPATCHING: {
      label: "ส่งมติออกแล้ว รอไฟล์ลงนามกลับ",
      cls: "st-pending",
      owner: "owner",
    },
  ...
  const TRANSITIONS = [
    ...
    },
    {
      ...
      actor: "secgen",
      ref: "S1→G1→G3→T7",
      guard: (k) => !g1Triggers(k).required && !!k.urgent,
    ...
    },
    {
      from: "PENDING_SECGEN",
      to: "RETURNED",
      event: "RETURN_TO_SOURCE",
      actor: "secgen",
      ref: "EX-01",
      note: "ส่งคืนออกนอกกิจกรรมที่ 7 กลับสายงานต้นทาง (กจ.5)",
    },
    ...
    /* ── G2 — คณะอนุสนับสนุนฯ ──────────────────────────────────────────── */
    {
      from: "IN_SUPPORT_SUB",
      to: "PENDING_CHAIR_OF",
      event: "SUPPORT_ALIGNED",
      actor: "support_sub",
      ref: "T6→G2→T8",
      note: "ความเห็นสอดคล้อง → Bypass ข้ามอนุกลั่นกรองฯ 1-8",
    },
    {
      from: "IN_SUPPORT_SUB",
      to: "PENDING_URGENT",
      event: "SUPPORT_DIVERGED_URGENT",
      actor: "support_sub",
      ref: "T6→G2→G3→T7",
      guard: (k) => !!k.urgent,
    ...
    },
    {
      from: "IN_SUPPORT_SUB",
      to: "PENDING_CHAIR_OF",
      event: "SUPPORT_DIVERGED",
      actor: "support_sub",
      ref: "T6→G2→G3→T8",
      guard: (k) => !k.urgent,
      note: "ไม่สอดคล้อง และไม่มีใบด่วน",
    },
    ...
    /* ── T7 — ผอ.กบค. รับรองใบด่วน (จุดควบคุม Bypass) ──────────────────── */
    {
      from: "PENDING_URGENT",
      to: "PENDING_CHAIR_OF",
      event: "URGENT_CERTIFY",
      actor: "dir_case",
      ref: "T7→T8",
      note: "ผอ.กบค. ลงนามรับรองเหตุผลเร่งด่วน",
    },
    {
      from: "PENDING_URGENT",
      to: "IN_SCREENING",
      ...
      actor: "dir_case",
      ref: "EX-09 A",
      note: "ไม่รับรองใบด่วน → ตัดสิทธิ์ Bypass บังคับกลับเส้นทางปกติที่ T9",
    },

    /* ── T8 · G4 — หน้าห้องประธานฯ และคำสั่งประธานฯ ────────────────────── */
    {
      from: "PENDING_CHAIR_OF",
      to: "PENDING_CHAIRMAN",
      event: "INTAKE_SCREEN",
      actor: "chair_office",
      ref: "T8→G4",
    ...
    {
      from: "PENDING_CHAIRMAN",
      to: "IN_SCREENING",
      event: "ORDER_SCREENING",
      actor: "chairman",
      ref: "G4→T9",
      note: "สั่งส่งกลั่นกรองตามปกติ",
    },
    {
      from: "PENDING_CHAIRMAN",
      to: "AGENDA_SET",
      event: "ORDER_AGENDA_URGENT",
      actor: "chairman",
      ref: "G4→T11",
      guard: (k) => !!k.urgentCertified,
    ...
    },
    {
      ...
      actor: "board_sec",
      ref: "EX-03 X3.2",
      note: "เลื่อน/ถอนวาระ — ต้องปิดเลขวาระเดิม",
    },
    {
      from: "DEFERRED",
      to: "AGENDA_SET",
      ...
      actor: "affairs",
      ref: "EX-03→T12",
      guard: (k) => !!k.newAgendaNo,
      note: "กลับเข้าประชุมต้องได้เลขวาระใหม่เสมอ",
    },

    /* ── หลังมติ — ล็อกไฟล์และส่งต่อ ───────────────────────────────────── */
    {
      from: "RESOLVED_PENDING",
      to: "RESOLVED",
      event: "LOCK_PDF",
      actor: "board_sec",
      ref: "T14",
      guard: (k) => can("EDIT.MASTER", k.actorRoleId) || !k.actorRoleId,
      note: "ล็อกไฟล์ PDF — แก้ไขได้เฉพาะ 7 คนที่มีสิทธิ์ EDIT.MASTER",
    },
    {
      from: "RESOLVED",
      to: "DISPATCHING",
      event: "DISPATCH_EXTERNAL",
      actor: "owner",
      ref: "G5 มติ 3",
      guard: (k) =>
        k.resolution === "FORWARD" &&
        !!k.forwardTo &&
        ...
        ถ้าปิดสำนวนได้โดยไม่มีสำเนาเก็บไว้ สำนักงานจะไม่มีหลักฐานตามที่กฎหมายบังคับ */
    {
      from: "DISPATCHING",
      to: "CLOSED",
      event: "UPLOAD_SIGNED_SCAN",
      actor: "owner",
      ref: "TOR 7.2.1.5 · ม.18/1",
      guard: (k) =>
        !!k.signedScanUploaded &&
        (!(forwardTarget(k.forwardTo) || {}).requireArchiveCopy ||
          !!k.archiveCopyKept),
    ...
    },
    {
      ...
      actor: "owner",
      ref: "G5 มติ 1/2",
      note: "รับไว้ไต่สวน (ยิงกลับ กจ.5) หรือไม่รับไว้ไต่สวน (ปิดสำนวน)",
    },
    {
      from: "RESOLVED",
      to: "AGENDA_SET",
      event: "REVISE_RESOLUTION",
      actor: "affairs",
      ref: "EX-03 X3.3",
      guard: (k) => !!k.newAgendaNo,
  ...
  function canTransition(from, to, kase) {
    ...
    if (k.actorRoleId) {
      ...
      if (!byActor.length)
        return {
          ok: false,
          reason: "WRONG_ACTOR",
          expected: cands.map((t) => t.actor),
        };
    }
    const pool = k.actorRoleId
      ? cands.filter((t) => t.actor === k.actorRoleId)
      : cands;
    ...
    return passed
      ...
      : {
          ok: false,
          reason: "GUARD_FAILED",
          guards: pool.map((t) => t.note || t.ref),
        };
  }
  ...
  const STATUS_STEP = {
    ...
    DRAFT: "secgen",
    RETURNED: "secgen",
    PENDING_SECTION: "secgen",
    PENDING_DIRECTOR: "secgen",
    PENDING_DEPUTY: "secgen",
    PENDING_SECGEN: "secgen",
    IN_SUPPORT_SUB: "secgen",
    PENDING_URGENT: "urgent",
    PENDING_CHAIR_OF: "chairman",
  ...
  /* ---- ตัวช่วยเรื่องขอบเขต ---- */
  function isUpstreamRole(roleId) {
    const r = getRole(roleId);
    return r.scope === "UPSTREAM";
  }
  function isUpstreamCase(kase) {
    const s = STATUS[kase.status];
    return !!(s && s.scope === "UPSTREAM");
  }
  ...
  function chainDivergence(kase) {
    ...
    if (diverged) {
      ...
      for (let i = 1; i < ops.length; i++) {
        if (ops[i].type !== ops[i - 1].type) {
          split = { from: ops[i - 1], to: ops[i] };
          break;
        }
      }
    }
  ...
  function boardQuorum({
    inOffice,
    present,
    forV = 0,
    againstV = 0,
    abstainV = 0,
    chairBreaksTie = false,
  }) {
    ...
    return {
      ...
      blockedBy: !boardValid
        ? "M10_BOARD_INCOMPLETE"
        : !quorumOk
          ? "M12_NO_QUORUM"
          : !majorityOk
            ? "M15_NO_MAJORITY"
  ...
  function panelComposition({ officers = 0, staff = 0 } = {}) {
    ...
    return {
      ...
      officerMin,
      exceptional:
        staff > M24P1_STAFF_FREE /* ใช้ "กรณีจำเป็น" ของวรรคหนึ่งอยู่ */,
  ...
  const M28_ORDERS = [
    ...
    {
      code: "REJECT",
      label: "สั่งไม่รับเรื่องไว้พิจารณา",
      lawRef: "ม.28 ประกอบ ม.25 / ม.26",
    },
    { code: "DISMISS", label: "สั่งจำหน่ายเรื่อง", lawRef: "ม.28 ประกอบ ม.26" },
  ];
  function m28Order(code) {
    return M28_ORDERS.find((o) => o.code === code) || null;
  }
  ...
  const CASES = [
    {
      id: "681547",
      subject:
        "กล่าวหาเจ้าหน้าที่องค์การบริหารส่วนตำบลแห่งหนึ่ง จัดซื้อจัดจ้างโครงการก่อสร้างถนน คสล. โดยมิชอบ",
      legalBase: "ม.18/4" /* ม.18/4 พรบ.มาตรการฯ | ม.62 พรป.ปปช. */,
      status: "PENDING_SECGEN",
      owner: "นายสมชาย ใจซื่อ",
      ownerOrg: "สนง. ป.ป.ท. เขต 1",
      complainant: "นายวิรัตน์ ศรีสุข (ผู้ร้อง)",
      accused: [
        {
          no: 1,
          name: "นายก้องภพ ทองแท้",
          pos: "นายกองค์การบริหารส่วนตำบล",
          idcard: "3-1009-0xxxx-xx-x",
          agency: "อบต.บางแสน",
        },
        {
          no: 2,
          name: "นางมาลี เรืองรอง",
          pos: "ปลัดองค์การบริหารส่วนตำบล",
          idcard: "3-1012-0xxxx-xx-x",
          agency: "อบต.บางแสน",
        },
        {
          no: 3,
          name: "นายชาญชัย ก่อสร้าง",
          pos: "ผู้อำนวยการกองช่าง",
          idcard: "3-2001-0xxxx-xx-x",
          agency: "อบต.บางแสน",
        },
      ],
      allegation:
        "ร่วมกันกำหนดคุณลักษณะเฉพาะของงานก่อสร้างเพื่อเอื้อประโยชน์ให้ผู้เสนอราคารายหนึ่งเป็นผู้ชนะการเสนอราคา และตรวจรับงานทั้งที่งานไม่แล้วเสร็จตามสัญญา",
      receivedDate: "2568-11-14",
      deadline60: "2569-01-13",
      deadline2y: "2570-11-14",
      prescription: "2571-03-20",
    ...
    },
    {
      id: "681602",
      subject:
        "กล่าวหาข้าราชการสังกัดกรมหนึ่ง เรียกรับเงินจากผู้ประกอบการเพื่อแลกกับการออกใบอนุญาต",
      legalBase: "ม.62",
      ...
      accused: [
        {
          no: 1,
          name: "นายเอกชัย รุ่งเรือง",
          pos: "นายช่างโยธาชำนาญงาน",
          idcard: "3-1005-0xxxx-xx-x",
          agency: "กรมโยธาธิการฯ",
        },
      ],
      allegation:
        "เรียกรับเงินจำนวน 50,000 บาท จากผู้ประกอบการเพื่อแลกกับการเร่งรัดออกใบอนุญาตก่อสร้าง",
      receivedDate: "2568-12-02",
      deadline60: "2569-01-31",
      deadline2y: "2570-12-02",
      prescription: "2569-09-18",
      docRef: "ปป 0020/1104 ลงวันที่ 20 พฤษภาคม 2569",
      urgent: true,
      urgentReason:
        "คดีใกล้ขาดอายุความภายใน 45 วัน และผู้ถูกร้องมีพฤติการณ์จะโอนย้ายหน่วยงาน",
      complex: false,
      dupWarning: false,
      slaDays: 6,
      slaLimit: 5,
    ...
    },
    {
      id: "681588",
      subject:
        "กล่าวหาเจ้าหน้าที่โรงพยาบาลรัฐแห่งหนึ่ง เบิกจ่ายค่าตอบแทนล่วงเวลาอันเป็นเท็จ",
      legalBase: "ม.18/4",
      status: "IN_SCREENING",
      owner: "นางสาวปรียา ตั้งมั่น",
      ownerOrg: "กองปราบปรามการทุจริตในภาครัฐ 2",
      complainant: "บัตรสนเท่ห์ (ความปรากฏต่อสำนักงาน)",
      accused: [
        {
          no: 1,
          name: "นายสุรชัย พัฒนา",
          pos: "นักจัดการงานทั่วไปชำนาญการ",
          idcard: "3-3007-0xxxx-xx-x",
          agency: "รพ.ศูนย์แห่งหนึ่ง",
        },
        {
          no: 2,
          name: "นางวราภรณ์ สุขใจ",
          pos: "เจ้าพนักงานการเงินและบัญชี",
          idcard: "3-3009-0xxxx-xx-x",
          agency: "รพ.ศูนย์แห่งหนึ่ง",
        },
      ],
      allegation:
        "ร่วมกันจัดทำเอกสารเบิกจ่ายค่าตอบแทนการปฏิบัติงานนอกเวลาราชการอันเป็นเท็จ รวม 47 ครั้ง เป็นเงิน 382,400 บาท",
      receivedDate: "2568-11-25",
      deadline60: "2569-01-24",
      deadline2y: "2570-11-25",
      prescription: "2572-01-10",
    ...
    },
    {
      id: "681490",
      subject:
        "กล่าวหาผู้บริหารสถานศึกษาแห่งหนึ่ง จัดซื้อครุภัณฑ์คอมพิวเตอร์ราคาสูงเกินจริง",
      legalBase: "ม.18/4",
      status: "AGENDA_SET",
      owner: "นายสมชาย ใจซื่อ",
      ownerOrg: "สนง. ป.ป.ท. เขต 1",
      ...
      accused: [
        {
          no: 1,
          name: "นายบัณฑิต ศึกษาดี",
          pos: "ผู้อำนวยการสถานศึกษา",
          idcard: "3-1102-0xxxx-xx-x",
          agency: "โรงเรียนแห่งหนึ่ง",
        },
      ],
      allegation:
        "อนุมัติจัดซื้อครุภัณฑ์คอมพิวเตอร์จำนวน 40 เครื่อง ในราคาสูงกว่าราคากลางที่กระทรวงดิจิทัลฯ กำหนด รวม 1,240,000 บาท",
      receivedDate: "2568-10-08",
      deadline60: "2568-12-07",
      deadline2y: "2570-10-08",
      prescription: "2570-06-30",
      ...
      slaDays: 2,
      slaLimit: 15,
      subCommittee: "คณะที่ 1",
      meetingNo: "37/2569",
      agendaNo: "5.9",
      meetingDate: "2569-05-19",
    },
    {
      id: "681455",
      subject:
        "กล่าวหาเจ้าหน้าที่สำนักงานที่ดินแห่งหนึ่ง ออกโฉนดที่ดินทับที่สาธารณประโยชน์",
      legalBase: "ม.62",
      status: "RESOLVED",
      owner: "นายสมชาย ใจซื่อ",
      ownerOrg: "สนง. ป.ป.ท. เขต 1",
      ...
      accused: [
        {
          no: 1,
          name: "นายมนตรี ที่ดินงาม",
          pos: "เจ้าพนักงานที่ดินชำนาญการ",
          idcard: "3-1201-0xxxx-xx-x",
          agency: "สนง.ที่ดินจังหวัด",
        },
      ],
      allegation:
        "ดำเนินการออกโฉนดที่ดินเลขที่ 12345 เนื้อที่ 8 ไร่ ทับที่สาธารณประโยชน์ โดยมิได้ตรวจสอบระวางแผนที่",
      receivedDate: "2568-09-15",
      deadline60: "2568-11-14",
      deadline2y: "2570-09-15",
      prescription: "2571-08-15",
      ...
      slaDays: 1,
      slaLimit: 15,
      subCommittee: "คณะที่ 2",
      meetingNo: "36/2569",
      agendaNo: "5.4",
      meetingDate: "2569-05-05",
      resolution: "ACCEPT_S24P1",
    },
    {
      id: "681610",
      subject:
        "กล่าวหาพนักงานรัฐวิสาหกิจแห่งหนึ่ง ทุจริตการเบิกจ่ายค่าน้ำมันเชื้อเพลิง",
      legalBase: "ม.18/4",
      status: "DRAFT",
      owner: "นายสมชาย ใจซื่อ",
      ownerOrg: "สนง. ป.ป.ท. เขต 1",
      ...
      accused: [
        {
          no: 1,
          name: "นายวีระ ขับขี่ดี",
          pos: "พนักงานขับรถยนต์",
          idcard: "3-1301-0xxxx-xx-x",
          agency: "รัฐวิสาหกิจแห่งหนึ่ง",
        },
      ],
      allegation: "เบิกจ่ายค่าน้ำมันเชื้อเพลิงโดยใช้ใบเสร็จรับเงินอันเป็นเท็จ",
      receivedDate: "2568-12-20",
      deadline60: "2569-02-18",
      deadline2y: "2570-12-20",
      prescription: "2573-02-01",
      docRef: "—",
      urgent: false,
      complex: false,
      dupWarning: false,
    ...
    },
    {
      id: "681523",
      subject:
        "กล่าวหาเจ้าหน้าที่เทศบาลแห่งหนึ่ง เรียกรับผลประโยชน์จากผู้ขออนุญาตประกอบกิจการ",
      legalBase: "ม.18/4",
      status: "RETURNED",
      owner: "นายสมชาย ใจซื่อ",
      ownerOrg: "สนง. ป.ป.ท. เขต 1",
      ...
      accused: [
        {
          no: 1,
          name: "นายอรรถพล เทศบาล",
          pos: "หัวหน้าฝ่ายพัฒนารายได้",
          idcard: "3-1405-0xxxx-xx-x",
          agency: "เทศบาลแห่งหนึ่ง",
        },
      ],
      allegation:
        "เรียกรับเงินจากผู้ประกอบการเพื่อแลกกับการออกใบอนุญาตประกอบกิจการที่เป็นอันตรายต่อสุขภาพ",
      receivedDate: "2568-11-01",
      deadline60: "2568-12-31",
      deadline2y: "2570-11-01",
      prescription: "2570-12-05",
      ...
      agendaNo: null,
      returnedBy: "director",
      returnedByName: "นายประเสริฐ มั่นคง (ผอ.สนง. ป.ป.ท. เขต 1)",
      returnReason: "DOC_INCOMPLETE",
      returnNote:
        "เอกสารพยานหลักฐานประกอบข้อ 3 (สำเนาใบอนุญาต) ยังไม่ครบถ้วน และยังไม่ได้แนบบันทึกถ้อยคำผู้ร้อง กรุณาแนบเพิ่มเติมแล้วเสนอกลับ",
    },
  ];
  ...
  CASES.push({
    id: "681615",
    subject:
      "กล่าวหาเจ้าหน้าที่สำนักงานเขตแห่งหนึ่ง ละเว้นการบังคับใช้กฎหมายควบคุมอาคาร",
    legalBase: "ม.18/4",
    status: "PENDING_SECGEN",
    owner: "นางสาวปรียา ตั้งมั่น",
    ownerOrg: "กองปราบปรามการทุจริตในภาครัฐ 2",
    ...
    accused: [
      {
        no: 1,
        name: "นายฉัตรชัย ตรวจการ",
        pos: "นายช่างโยธาอาวุโส",
        idcard: "3-1502-0xxxx-xx-x",
        agency: "สำนักงานเขตแห่งหนึ่ง",
      },
    ],
    allegation:
      "ละเว้นไม่ดำเนินการตามอำนาจหน้าที่กับอาคารที่ก่อสร้างผิดแบบแปลนที่ได้รับอนุญาต รวม 6 หลัง ต่อเนื่องกว่า 2 ปี",
    receivedDate: "2568-12-08",
    deadline60: "2569-02-06",
    deadline2y: "2570-12-08",
    prescription: "2572-05-30",
    ...
    chainOpinions: [
      {
        ...
        type: "ACCEPT",
        date: "2568-12-18",
        note: "พฤติการณ์ละเว้นชัดเจน มีเอกสารตรวจสอบรองรับ เห็นควรรับไว้ไต่สวน",
      },
      {
        roleId: "section_head",
        type: "ACCEPT",
        date: "2568-12-24",
        note: "เห็นพ้องตามที่เสนอ",
      },
      {
        roleId: "director",
        type: "ACCEPT",
        date: "2569-01-06",
        note: "เห็นชอบตามลำดับชั้น",
      },
      {
        roleId: "deputy",
        type: "ACCEPT",
        date: "2569-01-14",
        note: "เห็นควรเสนอเลขาธิการฯ ลงนาม",
      },
    ],
  });
  ...
  const M28_LOG = {
    681602: {
      orderType: "ACCEPT",
      orderedDate: "2569-05-22",
      reported: false,
      dueDate: "2569-06-06",
    },
    681588: {
      orderType: "ACCEPT",
      orderedDate: "2569-05-26",
      reported: false,
      dueDate: "2569-06-10",
    },
    681490: {
      orderType: "ACCEPT",
      orderedDate: "2569-04-30",
      reported: true,
      dueDate: "2569-05-15",
      boardOutcome:
        "บอร์ดไม่มีมติเป็นอย่างอื่นภายใน 15 วัน — ถือว่ามีมติตามคำสั่งเลขาธิการฯ",
    },
    681523: {
      orderType: "REJECT",
      orderedDate: "2569-05-28",
      reported: false,
      dueDate: "2569-06-12",
    },
  };
  CASES.forEach((c) => {
    if (M28_LOG[c.id]) c.m28 = M28_LOG[c.id];
  });
  ...
  const RETURN_REASONS = [
    ...
    {
      code: "FACT_UNCLEAR",
      label: "ข้อเท็จจริงยังไม่ชัดเจน ต้องแสวงหาเพิ่มเติม",
    },
  ...
  const RESOLUTIONS = [
    {
      ...
      doc: "คำสั่งแต่งตั้งองค์คณะพนักงาน ป.ป.ท. (ปปท. ๕-๐๑)",
      signer: "เลขาธิการฯ",
    },
    {
      code: "ACCEPT_S24P3",
     ...
     การไม่รับเรื่องไว้พิจารณา                                                */
    {
      ...
      doc: "หนังสือแจ้งคำสั่งจำหน่ายเรื่อง",
      signer: "—",
      needsLawRef: true,
      legalBasis: "ม.26 (ประกอบ ม.28)",
    },
    ...
    {
      code: "NO_GROUND",
      group: "ข้อกล่าวหาไม่มีมูล",
      label: "ข้อกล่าวหาไม่มีมูล — ข้อกล่าวหาเป็นอันตกไป (ม.32)",
      doc: "หนังสือแจ้งผลผู้ถูกกล่าวหา (ม.32 ไม่ช้ากว่า 15 วัน)",
      signer: "—",
      noticeDays: 15,
      noticeBasis:
    ...
    {
      code: "MORE_INVESTIGATE",
      group: "มติอื่น ๆ",
      label: "ให้ผู้รับผิดชอบสำนวนไต่สวนเบื้องต้นเพิ่มเติม",
      doc: "บันทึกแจ้งมติให้ไต่สวนเพิ่มเติม",
      signer: "—",
    },
  ...
  const FORWARD_TARGETS = [
    {
      code: "NACC",
      label: "สำนักงาน ป.ป.ช. (นอกอำนาจ ป.ป.ท.)",
      external: true,
      requireSignedScan: true,
      requireArchiveCopy: true,
      statutorySlaDays: 15,
      statutoryBasis:
        "ม.18/1 (ก)(3) / (ข)(1) / (ข)(3) — ส่งสำนวนภายใน 15 วัน · กำหนดตายตัวตามกฎหมาย ขยายไม่ได้",
      trackingSlaDays: 30,
      trackingBasis:
        "เล่ม 6 กิจกรรมที่ 8 · CHK011 — กรอบกำกับติดตาม 30 วันนับแต่วันที่ได้รับมติ (มิใช่กำหนดส่ง)",
      archiveBasis: "ม.18/1 — ต้องคัดสำเนาสำนวนเก็บรักษาไว้เป็นหลักฐาน",
      doc: "หนังสือนำส่งสำนวนถึงสำนักงาน ป.ป.ช.",
    },
    {
      code: "SCREENING",
      label: "คณะอนุกรรมการกลั่นกรองเรื่องไต่สวนข้อเท็จจริง",
      external: false,
      requireSignedScan: false,
      requireArchiveCopy: false,
      trackingSlaDays: 15,
      trackingBasis:
        "กรอบกำกับติดตามเชิงบริหารภายในสำนักงาน — กฎหมายไม่ได้กำหนดเส้นตายไว้",
  ...
  function forwardTarget(code) {
    return FORWARD_TARGETS.find((t) => t.code === code) || null;
  }
  ...
  function roleIdForLogin(username) {
    ...
    if (
      ...
      return "admin_legal";
    if (u.includes("napas") || u.includes("ณพัสตร") || u.includes("ผอ.กอง"))
      return "dir_legal";
    if (u.includes("arnon") || u.includes("อานนท์") || u.includes("ผอ.กลุ่ม"))
      return "group_director";
    if (u.includes("nattapol") || u.includes("ณัฐพล") || u.includes("นิติกร"))
      return "legal_officer";
    if (u.includes("siriporn") || u.includes("ศิริพร") || u.includes("กบค"))
  ...
  function inboxFor(roleId) {
      ...
      if (roleId === "dir_legal" || roleId === "Napas.S") {
        return actCases.filter(
          (c) =>
            ...
            (c.status &&
              (c.status.includes("ผอ.กองกฎหมาย") ||
                c.status.includes("เสนอผลมติ") ||
                c.status.includes("พิจารณาความเห็น") ||
                c.status.includes("รอมอบหมายกลุ่มงาน") ||
                c.status.includes("เสนอ ผอ.กองกฎหมาย"))),
        );
      }
      if (roleId === "group_director" || roleId === "Arnon.C") {
        return actCases.filter(
          (c) =>
            ...
            (c.status &&
              (c.status.includes("ผอ.กลุ่มงาน") ||
                c.status.includes("มอบหมายนิติกร") ||
                c.status.includes("ผอ.กลุ่ม") ||
                c.status.includes("ตรวจร่างความเห็น"))),
        );
      }
      if (roleId === "legal_officer" || roleId === "Nattapol.B") {
        return actCases.filter(
          (c) =>
            ...
            (c.officer &&
              (c.officer.includes("ณัฐพล") || c.officer.includes("กฤษดา"))) ||
    ...
    return CASES.filter(
      (c) => STATUS[c.status] && STATUS[c.status].owner === roleId,
    );
  }
  ...
  const NAV = [
    ...
    {
      href: "01-work-inbox.html",
      icon: "fa-inbox",
      label: "รายการงานกฎหมายและสำนวนคดี",
      badge: true,
      visible: (role) => true,
    },
    {
      href: "02-board-intake.html",
      icon: "fa-folder-plus",
      label: "บันทึกรับเรื่องเข้าระบบ",
      visible: (role) => role.id === "admin_legal" || role.id === "Kanda.R",
    },
    {
      href: "04-legal-director-review.html",
      icon: "fa-user-tie",
      label: "พิจารณาและมอบหมายเรื่อง",
      visible: (role) => role.id === "dir_legal" || role.id === "Napas.S",
    },
    {
      href: "08-legal-director-approval.html",
      icon: "fa-user-check",
      label: "ตรวจพิจารณาและสั่งการ",
      visible: (role) => role.id === "dir_legal" || role.id === "Napas.S",
    },
    {
      href: "11-legal-director-resolution.html",
      icon: "fa-file-circle-check",
      label: "พิจารณาผลมติและสั่งการ",
      visible: (role) => role.id === "dir_legal" || role.id === "Napas.S",
    },
    {
      href: "05-group-director-review.html",
      icon: "fa-user-gear",
      label: "พิจารณาและมอบหมายนิติกร",
      visible: (role) => role.id === "group_director" || role.id === "Arnon.C",
    },
    {
      href: "12-group-director-resolution.html",
      icon: "fa-user-pen",
      label: "พิจารณาผลมติและมอบหมายนิติกร",
      visible: (role) => role.id === "group_director" || role.id === "Arnon.C",
    },
    {
      href: "09-legal-admin-dispatch.html",
      icon: "fa-paper-plane",
      label: "ออกเลขส่งและส่งต่อผู้บริหาร",
      visible: (role) => role.id === "admin_legal" || role.id === "Kanda.R",
    },
    {
      href: "10-legal-admin-resolution.html",
      icon: "fa-file-signature",
      label: "รับผลมติและส่งต่อ ผอ.กองกฎหมาย",
      visible: (role) => role.id === "admin_legal" || role.id === "Kanda.R",
    },
  ];
  ...
  function renderShell(activeHref) {
    ...
    let notifications = [];
    const allCases =
      typeof Activity10 !== "undefined" && Activity10.getCases
        ? Activity10.getCases()
        : [];
    ...
    if (role.id === "legal_officer" || role.id === "Nattapol.B") {
      ...
      const officerCases = allCases.filter((c) => {
        return (
          c.assignedRole === "legal_officer" ||
          c.statusCode === "DRAFTING_OPINION" ||
          (c.officer && c.officer.includes("ณัฐพล"))
        );
      });
      ...
      if (officerCases.length > 0) {
        officerCases.forEach((c) => {
          const tor =
            typeof Activity10 !== "undefined" && Activity10.getTorDetails
              ? Activity10.getTorDetails(c)
              : {};
          const days =
            typeof Activity10 !== "undefined" &&
            Activity10.calculateDaysRemaining
              ? Activity10.calculateDaysRemaining(c)
              : typeof c.slaDaysRemaining === "number"
                ? c.slaDaysRemaining
                : 15;
        ...
        notifications = [
          {
            title: "🔴 เตือนกรอบเวลาเร่งด่วน (เหลือ 5 วัน)",
            body: "สำนวน คดี-2569/001 ครบกำหนดยกร่างความเห็นภายใน 5 วัน",
            time: "เร่งด่วน",
            icon: "fa-clock",
            cls: "bg-danger text-white",
          },
          {
            title: "🔴 เตือนกรอบเวลาเร่งด่วน (เหลือ 7 วัน)",
            body: "สำนวน คดี-2569/002 ครบกำหนดยกร่างความเห็นภายใน 7 วัน",
            time: "วันนี้",
            icon: "fa-clock",
            cls: "bg-danger text-white",
          },
          {
            title: "📋 ได้รับมอบหมายสำนวนใหม่",
            body: "สำนวน คดีปกครอง-2569/002 ให้จัดทำคำให้การเพิ่มเติม",
            time: "1 ชม. ที่แล้ว",
            icon: "fa-user-pen",
            cls: "bg-primary text-white",
          },
      ...
      notifications = [
        {
          title: "เสนอเรื่องใหม่",
          body: "สำนวน คดี-10.1-2569/001 รอลงนามความเห็นแย้ง",
          time: "10 นาทีที่แล้ว",
          icon: "fa-user-check",
          cls: "bg-primary text-white",
        },
        {
          title: "คำร้องขอเปิดเผยข้อมูล",
          body: "คำร้อง-10.2-2569/014 เข้าสู่ระบบแล้ว",
          time: "1 ชม. ที่แล้ว",
          icon: "fa-envelope-open-text",
          cls: "bg-success text-white",
        },
        {
          title: "เตือนกรอบเวลาคดีปกครอง",
          body: "คดีปกครอง-10.3-2569/002 เหลือเวลา 5 วัน",
          time: "2 ชม. ที่แล้ว",
          icon: "fa-clock",
          cls: "bg-warning text-dark",
        },
  ...
  <header class="app-topbar no-print">
    ...
    /* ---- sidebar ---- */
    const navHtml = visibleNavFor(role)
      .map((n) => {
        if (n.section) return `<div class="nav-section">${n.section}</div>`;
        const active = n.href === activeHref;
        const badge =
          n.badge && inboxCount
            ? `<span class="badge bg-danger rounded-pill">${inboxCount}</span>`
            : "";
        const step = n.step
          ? `<span class="step-no">${n.step}</span>`
  ...
  <nav class="app-sidebar no-print" id="appSidebar">
    ...
    if (collapseTog)
      collapseTog.addEventListener("click", () => toggleSidebarCollapse());
    ...
    document
      .querySelectorAll("table tbody:empty, table tbody")
      .forEach((tbody) => {
        if (!tbody.children.length) {
          const cols =
            tbody.closest("table")?.querySelectorAll("thead th").length || 4;
          tbody.innerHTML = Array.from(
            { length: 3 },
            () =>
              `<tr class="skeleton-row">${Array.from(
                { length: cols },
                () =>
  ...
  function statusBadge(statusKey) {
    ...
    return s
      ? `<span class="st ${s.cls}"><i class="fa-solid fa-circle-dot me-1" style="font-size: 0.65rem"></i>${s.label}</span>`
      : "";
  }
  ...
  function effectiveSlaLimit(kase) {
    return kase.status === "PENDING_SECGEN"
      ? secgenSlaLimit(kase)
      : kase.slaLimit;
  }
  ...
  function actionBar(kase, roleId, buttons) {
    ...
    if (isUpstreamCase(kase)) {
      ...
      const ownerRole = STATUS[kase.status]
        ? getRole(STATUS[kase.status].owner)
        : null;
      ...
      inner = buttons
        ...
        <i class="fa-solid ${b.icon} me-1"></i>${b.label}</button>`,
        )
        .join("");
    } else {
      const ownerRole = STATUS[kase.status]
  ...
  function sequentialSignDialog(docName, signers) {
    ...
    <div class="d-flex align-items-start gap-2 mb-2" style="font-size:.82rem">
      ...
      <div>
        ...
        ${
          i === 0
            ? '<div class="text-muted" style="font-size:.74rem">ลงนามในขั้นตอนนี้</div>'
    ...
    return Swal.fire({
      ...
      <div class="mb-2" style="background:#fdf7e8;border-left:4px solid #c9a227;padding:.6rem .8rem;border-radius:0 6px 6px 0">
        ...
        ${
          rest.length
            ? `<br><small>เมื่อลงนามลำดับนี้แล้ว เอกสารจะส่งต่อให้ <strong>${rest[0].name}</strong>
      ...
      showCancelButton: true,
      confirmButtonText: "ยืนยันลงนามลำดับนี้",
      cancelButtonText: "ยกเลิก",
      confirmButtonColor: "#0a2647",
      cancelButtonColor: "#6b7280",
      reverseButtons: true,
  ...
  function changeFont(dir) {
    ...
    toastOk(
      `ปรับขนาดตัวอักษรเป็น: ${dir > 0 ? "ใหญ่ขึ้น" : dir < 0 ? "เล็กลง" : "ปกติ"}`,
    );
  }
  ...
  function initA11yAndPref() {
    ...
    const fontStepVal = parseInt(
      localStorage.getItem("ecmis_font_step") || "0",
      10,
    );
    ...
    const isCollapsed =
      localStorage.getItem("ecmis_sidebar_collapsed") === "true";
    if (isCollapsed) {
  ...
  <div class="cmd-palette-backdrop no-print" id="cmdPalette">
    ...
    input.addEventListener("keydown", (e) => {
      ...
      let activeIdx = Array.from(items).findIndex((el) =>
    ...
    function renderResults(q) {
      ...
      const menus = visibleNavFor(currentRole())
        .filter((n) => n.href)
        .map((n) => ({
          label: n.step ? `${n.label} (ขั้นตอน ${n.step})` : n.label,
          href: n.href,
          icon: n.icon,
          cat: "Menu",
        }));

      const matchedMenus = menus.filter((m) =>
      ...
      if (matchedCases.length) {
        ...
        matchedCases.forEach((c, idx) => {
          ...
          const PAGE_FOR = {
            owner: "03-report-213.html",
            section_head: "03-report-213.html",
            director: "03-report-213.html",
            deputy: "03-report-213.html",
            secgen: "04-approval-review.html",
            support_sub: "04-approval-review.html",
            chair_office: "06-chairman-agenda.html",
            chairman: "06-chairman-agenda.html",
            subcommittee: "07-subcommittee-screening.html",
            board_sec: "08-board-resolution.html",
            board: "08-board-resolution.html",
          };
  ...
  function initSmartCombobox(selectEl) {
    if (
      !selectEl ||
      selectEl.nextElementSibling?.classList.contains("smart-combo-container")
    )
      return;
    ...
    toggleBtn.textContent =
      selectEl.options[selectEl.selectedIndex]?.text || "— เลือกรายการ —";
    ...
    function renderItems(filterText) {
      ...
      const filtered = options.filter(
        (o) => o.text.toLowerCase().includes(q) && o.value !== "",
      );
    ...
    toggleBtn.addEventListener("click", (e) => {
      ...
      document
        .querySelectorAll(".smart-combo-dropdown")
  ...
  function toggleVoiceRecognition(textareaId) {
    ...
    if (!SpeechRecognition) {
      toastWarn(
        "เบราว์เซอร์ของคุณไม่รองรับการพิมพ์ด้วยเสียง (Speech Recognition)",
      );
      return;
    }
    ...
    if (
      ...
      ta.hasAttribute("readonly") ||
      ta.hasAttribute("data-no-voice")
    ) {
  ...
  function initVoiceInput() {
    ...
    textareas.forEach((ta) => {
      ...
      if (ta.id && !document.getElementById("voiceBtn-" + ta.id)) {
        ...
        if (counter) {
          counter.parentNode.insertBefore(
            document.createRange().createContextualFragment(buttonHtml),
            counter,
          );
        } else {
  ...
  function initCharCounterAndCopy() {
    ...
    textareas.forEach((ta) => {
      if (
        ta.hasAttribute("readonly") ||
        ta.hasAttribute("disabled") ||
        ta.hasAttribute("data-no-helper") ||
        ta.hasAttribute("data-no-copy")
      )
        return;
      if (ta.nextElementSibling?.classList.contains("textarea-helper-bar"))
        return;

      const bar = document.createElement("div");
      bar.className =
        "textarea-helper-bar d-flex justify-content-between align-items-center mt-1 px-1";
  ...
  function initDragDropUpload(zoneId, fileListId, allowedTypes, maxMB) {
    ...
    function renderFile(file) {
      ...
      const iv = setInterval(() => {
        ...
        if (pct >= 100) {
          clearInterval(iv);
          fill.style.background = "var(--ecmis-ok)";
        }
      }, 120);
    }
    ...
    function handleFiles(files) {
      Array.from(files).forEach((f) => {
        if (f.size > MB) {
          toastWarn(`ไฟล์ "${f.name}" มีขนาดเกิน ${maxMB || 10} MB`);
          return;
        }
        if (
          allowedTypes &&
          !allowedTypes.some((t) => f.name.toLowerCase().endsWith(t))
        ) {
          toastWarn(`ไฟล์ "${f.name}" ไม่ใช่ประเภทที่รองรับ`);
          return;
        }
        renderFile(f);
      });
    ...
    const runToggleInit = () => {
      ...
      function setDocVisibility(hide) {
        ...
        if (isHidden) {
          ...
          formCol.className = origClass.replace(
            /col-(xl|lg|md)-\d+/g,
            "col-12 col-xl-12 col-lg-12",
          );
        } else {
      ...
      function updateButtons() {
        document.querySelectorAll(".btn-doc-toggle").forEach((btn) => {
          if (isHidden) {
            ...
            btn.innerHTML =
              '<i class="fa-solid fa-eye-slash me-1"></i>ซ่อนเอกสาร';
      ...
      const pageHeadTarget =
        document.querySelector(".page-head .ms-auto") ||
        document.querySelector(".page-head");
      if (pageHeadTarget && !document.querySelector(".btn-doc-toggle-header")) {
        const headBtn = document.createElement("button");
        headBtn.type = "button";
        headBtn.className =
          "btn btn-sm btn-outline-secondary btn-doc-toggle btn-doc-toggle-header ms-2 no-print";
